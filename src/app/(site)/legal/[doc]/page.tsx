...
const DOCS = {
  terms: {
    ...
    body: [
      "These terms cover use of Encore as a ticket buyer and as an event organizer. By creating an account you agree to them.",
      "Organizers are responsible for the events they publish: the description, the pricing, admission, and honouring the refund policy they set. Encore provides the platform and collects a service fee on paid orders; it is not the promoter of any event listed here.",
  ...
  privacy: {
    ...
    body: [
      ...
      "Card details are handled by Stripe and never touch Encore's servers. We store only the payment reference needed to reconcile and refund an order.",
